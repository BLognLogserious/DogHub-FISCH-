...
local trueData = "43ffbef0bc064746a103772fb30e478f"
local falseData = "21b31722d8e144719a5aaf38ee4871c9"

KeyGuardLibrary.Set({
  publicToken = "277a8575f47e45619c7d1935368254f0",
  privateToken = "82bffc840ff046bfa23f9a1b3b42d8be",
  trueData = trueData,
  falseData = falseData,
})
...
local Checkkey = Tabs.KeySys:AddButton({
    ...
    Callback = function()
        ...
        if response == trueData then
           print("Key is valid")
           if getgenv().hub then warn("Dog Hub |🐟FISCH🐟 / By Dog") return end
getgenv().hub = true
...
local Window = Fluent:CreateWindow({
    Title = game:GetService("MarketplaceService"):GetProductInfo(16732694052).Name .."Dog Hub | 🦈FISCH🦈 / By DogS",
    SubTitle = " (https://discord.gg/jjxB55Ke)", -- discord link
    TabWidth = 160,
...
do
    Tabs.Home:AddButton({
        ...
        Callback = function()
            setclipboard("https://discord.gg/jjxB55Ke") -- discord link
        end
    })
